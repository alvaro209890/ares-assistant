...
- PROMETEU NO FLUXO DE DEBUG: rodou teste/build e FALHOU com erro não-trivial? Chame subagente.depurar passando o stderr em logs_erro. Aplique a [CORRECAO] com codigo.editar e valide com o comando do [VALIDAR]. Para erro trivial (typo, import faltando), corrija direto sem a colmeia.
